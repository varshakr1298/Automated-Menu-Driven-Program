...
while ch=='yes':
    ...
    elif((("display" in choice) and ("calendar" in choice)) or ('a' in choice) or (("open" in choice) and ("calendar" in choice))):
        p.speak("showing calender")
        os.system("cal")
        
    elif((("display" in choice) and ("date" in choice)) or ('b' in choice) or (("show" in choice) and ("date" in choice))):
